...
<body>
    <div class="container p-5">
        ...
        <form action="{{ route('stok.update', $edit->id) }}" method="post">
            @csrf
            <div class="mt-3 row">
                ...
                <div class="col-sm-4">
                    <select class="form-control" required name="kelas">
                        ...
                        @php
                        for ($x = 1; $x <= 6; $x++) { @endphp <option value="{{ $x }}" @if($edit->kelas == $x) selected @endif >{{ $x }}</option>
                            @php
                            }
                            @endphp
            ...
            <div class="mt-3 row">
                ...
                <div class="col-sm-4">
                    <input type="number" class="form-control" id="inputHarga" value="{{ $edit->harga }}" name="harga" required>
                </div>
            </div>
            <div class="mt-3 row">
                <div class="col-sm-5">
        ...
        <table class="table table-striped mt-5">
            ...
            <tr>
                ...
                <td class="text-center">{{ $stok->kelas }}</td>
                ...
                <td class="text-center">
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('stok.edit', $stok->id ) }}" class="btn  btn-outline-danger"><i class="fa-solid fa-trash"></i></a>
                        </div>
                    </div>
                </td>
            </tr>
